...
class AwsCompileFunctions {
  ...
  compileFunction(functionName) {
    ...
    if (globby.hasMagic(artifactFilePath)) {
      artifactFilePath = globby.sync(artifactFilePath);
      ...
      if (artifactFilePath.length !== 1) {
        artifactFilePath = artifactFilePath[artifactFilePath.length - 1].toString();
      } else {
        artifactFilePath = artifactFilePath[0].toString();
      }
    }
    ...
    console.log(typeof artifactFilePath);
