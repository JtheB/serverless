...
const getOneFilePathThroughPattern = require('../utils/fs/getOneFilePathThroughPattern');
...
class Utils {
  ...
  getOneFilePathThroughPattern(filePath) {
    return getOneFilePathThroughPattern(filePath);
  }
